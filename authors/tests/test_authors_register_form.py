...
class AuthorRegisterFormIntegrationTest(DjangoTestCase):
    ...
    def test_fields_cannot_be_empty(self, field, msg):
        ...
        )  # follow=True to get redirection
    ...
    def test_password_field_have_lower_upper_case_letters_and_numbers_error(self): # noqa
    ...
    def test_password_field_have_lower_upper_case_letters_and_numbers_pass(self): # noqa
    ...
    def test_error_if_password_and_password_confirmation_are_diferent(self):
        ...
        self.assertIn(msg, response.content.decode('utf-8'))
        self.assertIn(msg, response.context['form'].errors.get('password'))
        self.assertIn(msg, response.context['form']
