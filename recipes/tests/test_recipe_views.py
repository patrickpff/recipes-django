...
class RecipeViewsTest(RecipeTestBase):
    ...
    def test_recipe_category_template_dont_load_category_recipes_not_published(self):
        """Test if recipe is_published = False doesn't show """
    ...
    def test_recipe_detail_template_dont_load_category_recipes_not_published(self):
        """Test if recipe is_published = False doesn't show """
        recipe = self.make_recipe(is_published=False)
